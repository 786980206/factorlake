...
|------|------|---------------|---------------|------------------|-------------|
| 100 sym | 1,315,900 | 0.124 | 0.297 | 0.699 | 0.215 |
| 500 sym | 6,579,500 | 0.515 | 1.233 | 1.458 | 0.616 |
| 1000 sym | 13,159,000 | 1.092 | 2.422 | 2.108 | 1.131 |
| 2000 sym | 26,318,000 | 2.123 | 5.287 | 4.203 | 2.113 |
| 4000 sym | 52,636,000 | 5.344 | 12.986 | 8.092 | 6.017 |

### 2.3 倍率分析（Aligned panel / Native year-part）

| 规模 | 倍率 | 结论 |
|------|------|------|
| 100 sym | 0.42× | **aligned 快 2.4×** |
| 500 sym | 0.85× | **aligned 快 1.2×** |
| 1000 sym | 1.15× | aligned 慢 1.2× |
| 2000 sym | 1.26× | aligned 慢 1.3× |
| 4000 sym | 1.60× | aligned 慢 1.6× |
