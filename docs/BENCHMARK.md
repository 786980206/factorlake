...
|------|------|---------------|---------------|------------------|-------------|
| 100 sym | 1,315,900 | 0.150 | 0.312 | 0.709 | 0.219 |
| 500 sym | 6,579,500 | 0.555 | 1.101 | 1.500 | 0.567 |
| 1000 sym | 13,159,000 | 1.331 | 2.583 | 2.044 | 1.266 |
| 2000 sym | 26,318,000 | 3.070 | 6.303 | 4.015 | 2.446 |
| 4000 sym | 52,636,000 | 11.872 | 21.802 | 8.255 | 5.200 |

### 2.3 倍率分析（Aligned panel / Native year-part）

| 规模 | 倍率 | 结论 |
|------|------|------|
| 100 sym | 0.44× | **aligned 快 2.3×** |
| 500 sym | 0.73× | **aligned 快 1.4×** |
| 1000 sym | 1.26× | aligned 慢 1.3× |
| 2000 sym | 1.57× | aligned 慢 1.6× |
| 4000 sym | 2.64× | aligned 慢 2.6× |
