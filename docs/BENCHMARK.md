...
|------|------|---------------|---------------|------------------|-------------|
| 100 sym | 1,315,900 | 0.121 | 0.268 | 0.719 | 0.206 |
| 500 sym | 6,579,500 | 0.543 | 1.302 | 1.396 | 0.719 |
| 1000 sym | 13,159,000 | 1.201 | 2.513 | 2.086 | 1.050 |
| 2000 sym | 26,318,000 | 2.401 | 5.409 | 3.993 | 2.379 |
| 4000 sym | 52,636,000 | 5.585 | 13.714 | 8.027 | 7.430 |

### 2.3 倍率分析（Aligned panel / Native year-part）

| 规模 | 倍率 | 结论 |
|------|------|------|
| 100 sym | 0.37× | **aligned 快 2.7×** |
| 500 sym | 0.93× | **aligned 快 1.1×** |
| 1000 sym | 1.20× | aligned 慢 1.2× |
| 2000 sym | 1.35× | aligned 慢 1.4× |
| 4000 sym | 1.71× | aligned 慢 1.7× |
