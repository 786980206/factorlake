...
$out = Run-DuckDB "SET aligned_data_root='$dataRoot'; WITH t AS (SELECT * FROM aligned_table('cnstk_ixday')) SELECT count(*) AS c, count(alpha001) AS a1, count(alpha099) AS a99, count(rowid_ma) AS ma, sum(CASE WHEN rowid != rowid_alpha THEN 1 ELSE 0 END) AS mis FROM t;"
...
$out = Run-DuckDB "SET aligned_data_root='$dataRoot'; SELECT rowid, ma5 FROM aligned_table('cnstk_ixday') WHERE rowid IN (0, 1999, 2000, 5999) ORDER BY rowid;"
...
$out = Run-DuckDB "SET aligned_data_root='$dataRoot'; SELECT count(*), sum(rowid_alpha) FROM aligned_table('cnstk_ixday') WHERE rowid >= 2000;"
...
$out = Run-DuckDB "SET aligned_data_root='$dataRoot'; SELECT alpha099 FROM aligned_table('cnstk_ixday') WHERE rowid = 4500;"
...
$out = Run-DuckDB "SET aligned_data_root='$dataRoot'; SELECT symbol FROM aligned_table('cnstk_ixday') WHERE rowid IN (1999, 2000, 3999, 4000) ORDER BY rowid;"
...
$out = Run-DuckDB "SET aligned_data_root='$dataRoot'; SELECT alpha001, ma20, date FROM aligned_table('cnstk_ixday') WHERE rowid IN (2000, 4095) ORDER BY rowid;"
...
$out = Run-DuckDB "SET aligned_data_root='$dataRoot'; SELECT count(*) FROM aligned_table('cnstk_ixday') WHERE date = DATE '2026-08-01';"
...
$out = Run-DuckDB "SET aligned_data_root='$dataRoot'; SELECT count(*) FROM aligned_table('cnstk_ixday') WHERE date = DATE '2026-07-01';"
...
$out = Run-DuckDB "SET aligned_data_root='$dataRoot'; SELECT count(*) FROM aligned_table('cnstk_ixday') WHERE date = DATE '2026-08-01' AND rowid < 100;"
...
$out = Run-DuckDB "SET aligned_data_root='$dataRoot'; SELECT count(*) FROM aligned_table('cnstk_ixday') WHERE date = DATE '2026-08-01' AND rowid >= 2000;"
...
$out1 = Run-DuckDB "SET aligned_data_root='$dataRoot'; SET threads=1; SELECT count(*), count(alpha001), count(alpha099), count(rowid_ma), sum(rowid) FROM aligned_table('cnstk_ixday');"
$out8 = Run-DuckDB "SET aligned_data_root='$dataRoot'; SET threads=8; SELECT count(*), count(alpha001), count(alpha099), count(rowid_ma), sum(rowid) FROM aligned_table('cnstk_ixday');"
...
$out = Run-DuckDB-File "SET aligned_data_root='$dataRoot'; SELECT ""factor.alpha101.vwap"" AS a, ""fieldset.ma.vwap"" AS m FROM aligned_table('cnstk_ixday') WHERE rowid = 2000;"
...
$out = Run-DuckDB "SET aligned_data_root='$dataRoot'; SELECT rowid_alpha, ma5 FROM aligned_table('cnstk_ixday') WHERE rowid = 2000;"
...
$prevEAP = $ErrorActionPreference
$ErrorActionPreference = 'Continue'
$out = & $db -c "SET aligned_data_root='$dataRoot'; SELECT * FROM aligned_table('badname');" 2>&1 | Out-String
$ErrorActionPreference = $prevEAP
...
$prevEAP = $ErrorActionPreference
$ErrorActionPreference = 'Continue'
$out = & $db -c "SET aligned_data_root='$dataRoot'; SELECT * FROM aligned_table('badrows');" 2>&1 | Out-String
$ErrorActionPreference = $prevEAP
